...
namespace Testosterone {
    public class Config {
        public string ServerName = "FemtoCraft Server";
        ...
        public bool AdminSlot = true;
        public bool RevealOps = false;
        public bool AllowEmails = false;
        public string HeartbeatUrl = "https://minecraft.net/heartbeat.jsp";

        public int MaxConnections = 3;
        public bool LimitClickRate = true;
        public bool LimitClickDistance = true;
        public bool LimitChatRate = true;
        public bool AllowSpeedHack = false;

        public int OpMaxConnections = 3;
        public bool OpLimitClickRate = true;
        public bool OpLimitClickDistance = true;
        public bool OpLimitChatRate = true;
        public bool OpAllowSpeedHack = true;

        public int PhysicsTick = 50;
        public bool Physics = true;
        public bool PhysicsFloodProtection = false;
        public bool PhysicsGrass = true;
        public bool PhysicsLava = true;
        public bool PhysicsPlants = true;
        public bool PhysicsSand = true;
        public bool PhysicsSnow = true;
        public bool PhysicsTrees = false;
        public bool PhysicsWater = true;

        public bool AllowWaterBlocks = false;
        public bool AllowLavaBlocks = false;
        public bool AllowGrassBlocks = false;
        public bool AllowSolidBlocks = false;
        public bool OpAllowWaterBlocks = true;
        public bool OpAllowLavaBlocks = true;
        public bool OpAllowGrassBlocks = true;
        public bool OpAllowSolidBlocks = true;

        public string OpColor = "&3";
        ...
        public void Load(string fileName) {
            if (!File.Exists(fileName)) {
                throw new FileNotFoundException("Could not find specified config file.", fileName);
            }
            ...
            Logger.Log("Config: Loaded configuration from {0}", fileName);
        }
